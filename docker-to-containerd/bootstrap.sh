...
cat >>/etc/hosts<<EOF
172.16.16.100   kube-master.example.com     kube-master
172.16.16.101   kube-worker-1.example.com    kube-worker-1
172.16.16.102   kube-worker-2.example.com    kube-worker-2
EOF